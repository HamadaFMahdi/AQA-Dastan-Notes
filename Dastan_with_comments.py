...
class Dastan:
    ...
    def __GetPointsForOccupancyByPlayer(self, CurrentPlayer):
        # Points for mirza OCCUPYING the fortress.
        ScoreAdjustment = 0
        for S in self._Board:
